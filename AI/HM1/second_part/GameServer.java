...
class GameServer
{
    ...
    private void playerShoot(SPlayer pPlayer)
    {
        ...
        try
        {
            ...
            {
                System.err.println("shoot1 - getline failed for player " + pPlayer.mID);
        ...
        {
            System.err.println("shoot2 - getline failed for player " + pPlayer.mID);
            pPlayer.mGameOver = true;
            return;
        }
    ...
    private void playerGuess(SPlayer pPlayer)
    {
        ...
        try
        {
            if ((lString = pPlayer.mInputStream.readLine()) == null)
            {
                System.err.println("guess1 - getline failed for player " + pPlayer.mID);
                pPlayer.mGameOver = true;
                return;
            }
        }
        ...
        {
            System.err.println("guess2 - getline failed for player " + pPlayer.mID);
            pPlayer.mGameOver = true;
            return;
        }
